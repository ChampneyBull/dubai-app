    ...
    return (
        <div className={`flex flex-col min-h-screen bg-[#0c140c] text-white p-6 mx-auto transition-all duration-500 ${viewType === 'list' ? 'max-w-sm' : 'max-w-md'}`}>
            ...
            {viewType === 'list' ? (
                <>
                    {/* Leader card */}
                    <div className="bg-gradient-to-br from-[#1b5e20] to-[#2e7d32] rounded-[2.5rem] p-8 mb-10 relative overflow-hidden shadow-2xl shadow-green-900/30 min-h-[220px] flex flex-col justify-center text-left">
